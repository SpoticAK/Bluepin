...
export default function BiomarkersTab() {
 ...
 <>
 <ReferenceArea y1={0} y2={Number(selectedBiomarker.biomarker.refMax)} {...({ fill: "#22c55e", fillOpacity: 0.15, stroke: "none", ifOverflow: "hidden" } as any)} />
 <ReferenceLine y={Number(selectedBiomarker.biomarker.refMax)} stroke="#22c55e" strokeWidth={2} strokeDasharray="4 4" opacity={0.8} />
 </>
 )}

 {(selectedBiomarker.biomarker.refMin !== undefined && selectedBiomarker.biomarker.refMin !== null) && !(selectedBiomarker.biomarker.refMax !== undefined && selectedBiomarker.biomarker.refMax !== null) && (
 <>
 <ReferenceArea y1={Number(selectedBiomarker.biomarker.refMin)} y2={Math.max(Number(selectedBiomarker.biomarker.refMin) * 10, 10000)} {...({ fill: "#22c55e", fillOpacity: 0.15, stroke: "none", ifOverflow: "hidden" } as any)} />
 <ReferenceLine y={Number(selectedBiomarker.biomarker.refMin)} stroke="#22c55e" strokeWidth={2} strokeDasharray="4 4" opacity={0.8} />
 </>
 )}
